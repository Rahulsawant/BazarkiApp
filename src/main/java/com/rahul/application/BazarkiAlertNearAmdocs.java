 ...
 */
public class BazarkiAlertNearAmdocs implements Runnable{
    ...
    String subject;
    String url;
    public BazarkiAlertNearAmdocs(String sendTo,String subject){
        this.sendTo=sendTo;
        this.subject=subject;
    }
    public BazarkiAlertNearAmdocs(String url,HashMap<String,Object> filters,String sendTo,String subject){
    ...
    public void run() {
        ...
        System.out.println("Running BazarkiAlertNearAmdocs Alert start--");
        setHtmlBodyContent();
        ...
        if(AppExecutor.bazarkiAlertCountNearAmdocs == null || AppExecutor.bazarkiAlertCountNearAmdocs != listOfAptCount){
        ...
        AppExecutor.bazarkiAlertCountNearAmdocs=listOfAptCount;
        System.out.println("Running BazarkiAlertNearAmdocs Alert End--");
    }
